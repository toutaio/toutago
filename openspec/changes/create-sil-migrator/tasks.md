...
- [ ] 1.1.2 Initialize Go module with `go mod init github.com/toutaio/toutago-sil-migrator` (Go 1.22+)
...
- [ ] 2.3.1 Create `DatamapperAdapter` struct in `pkg/sil/adapters/datamapper.go`
- [ ] 2.3.2 Implement bridge to use datamapper's database adapters
- [ ] 2.3.3 Add optional dependency on toutago-datamapper (build tags)
- [ ] 2.3.4 Implement adapter method mapping (Exec, Query, BeginTx)
- [ ] 2.3.5 Add datamapper configuration file support
- [ ] 2.3.6 Write datamapper integration tests
- [ ] 2.3.7 Document datamapper integration usage
- [ ] 2.3.8 Create example showing datamapper + Síl integration

### 2.4 Adapter Testing Framework
- [ ] 2.4.1 Create adapter compliance test suite
- [ ] 2.4.2 Define standard test scenarios for all adapters
- [ ] 2.4.3 Implement automated adapter testing
- [ ] 2.4.4 Add performance benchmarks for adapters
- [ ] 2.4.5 Create adapter comparison documentation

### 2.5 Adapter Factory
- [ ] 2.5.1 Create adapter factory pattern in `pkg/sil/adapters/factory.go`
- [ ] 2.5.2 Implement adapter registration system
- [ ] 2.5.3 Add adapter auto-detection from connection string
- [ ] 2.5.4 Support custom adapter registration (including datamapper)
- [ ] 2.5.5 Add adapter validation

### 2.6 Testing - Phase 2
- [ ] 2.6.1 Write cross-database migration tests
- [ ] 2.6.2 Test adapter switching scenarios
- [ ] 2.6.3 Test multi-database applications
- [ ] 2.6.4 Write compatibility tests for all adapters (including datamapper)
- [ ] 2.6.5 Achieve 85%+ code coverage

### 2.7 Documentation - Phase 2
- [ ] 2.7.1 Document all supported databases
- [ ] 2.7.2 Create database-specific migration guides
- [ ] 2.7.3 Document adapter selection guide
- [ ] 2.7.4 Create multi-database examples
- [ ] 2.7.5 Document custom adapter creation
- [ ] 2.7.6 Document datamapper integration setup and benefits
...
- [ ] 4.10.3 Create datamapper integration example in `examples/with-datamapper/`
- [ ] 4.10.4 Create Toutā integration example in `examples/with-touta/`
- [ ] 4.10.5 Create Docker example with migrations
- [ ] 4.10.6 Create CI/CD integration example
